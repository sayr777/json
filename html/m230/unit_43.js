...
setInterval(function(){ getData('m_43');}, 200);
 ...
 function parseArray(unitName,data) 
{
                 ...
                 for (var i = 0; i < data.length; i++) 
           {
                ...
                if(data[i].Name == unitName && data[i].Param == 'Energy_0' ) { 
                                  ...
                                  document.getElementById("Energy_0_0").innerHTML=(data[i].Energy_0[0]*0.001).toFixed(2);
                                  document.getElementById("Energy_0_1").innerHTML=(data[i].Energy_0[1]*0.001).toFixed(2);
                                  document.getElementById("Energy_0_2").innerHTML=(data[i].Energy_0[2]*0.001).toFixed(2);
                                  document.getElementById("Energy_0_3").innerHTML=(data[i].Energy_0[3]*0.001).toFixed(2);
               }
