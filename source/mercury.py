...
0x40]
##########################################################################
#def hexOut(hexString):
  #   s=str(hex(hexString)[2:])
  #   if(len(s) == 1 ):
  #       return '0'+s
 #    else:
  #        return s
...
def getEn0(netAdr,ser):
     try:
       ...
       #  print( Aplus, Aminus^0xFFFFFFFF,Rplus,Rminus^0xFFFFFFFF)
     except Exception as e:
         print ('getEn0- ',e)
...
def getConnect(netAdr,ser):
     try:
         ...
         if(reqString[0] == int(netAdr) ):
             ...
             ret = 0 
       #  print (str(binascii.hexlify(reqString)))
     except Exception as e:
        # print ('getConnect',e)
         ret=0
     return ret
...
def getDataFromCounter(netAdr,serialPort,DEBUG):
     ...
     try:
         ...
         if(getConn == 1):
             if(DEBUG == 1): print( 'Unit ' + str(netAdr) + ' turn On')
             openChannel=sndOpCh(netAdr,serialPort)
             if(openChannel == 1):
                 if(DEBUG == 1):  print( 'Opened chanel for ' + str(netAdr))
     ...
     #return sn1,sn2,sn3,sn4,freq,Aplus,Aminus,Rplus,Rminus,Aplus1,Aminus1,Rplus1,Rminus1,Aplus2,Aminus2,Rplus2,Rminus2,Aplus3,Aminus3,Rplus3,Rminus3,Aplus4,Aminus4,Rplus4,Rminus4,U1,U2,U3
